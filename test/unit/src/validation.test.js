...
describe("Validation tests", function () {
    ...
    describe("#email", function () {
        ...
        it("should allow a standard email", function () {
        ...
        it("should allow an email with special characters", function () {
        ...
        it("should throw an error for invalid email strings", function () {
        ...
        it("should throw an error for invalid datatypes", function () {
    ...
    describe("#required", function () {
        ...
        it("should be return true when values are given", function () {
    ...
    describe("#minLength", function () {
        ...
        it("should return true when min length met or exceeded", function () {
        ...
        it("should throw error when under min length", function () {
        ...
        it("should throw error if length less than 0", function () {
        ...
        it("should throw error if non integer passed over as length", function () {
        ...
        it("should throw error if non string passed over as value", function () {
    ...
    describe("#maxLength", function () {
        ...
        it("should return true when less than or equal to max length", function () {
        ...
        it("should throw error when over max length", function () {
    ...
    describe("#length", function () {
        ...
        it("should return true when value is given length", function () {
        ...
        it("should throw error when not equal to length", function () {
    ...
    describe("#lengthBetween", function () {
        ...
        it("should return true when value is between given lengths", function () {
        ...
        it("should throw error when not between lengths", function () {
        ...
        it("should throw error when minLength less than 0", function () {
        ...
        it("should throw error when maxLength less than minLength", function () {
        ...
        it("should throw error if non integer passed over as minLength", function () {
        ...
        it("should throw error if non integer passed over as maxLength", function () {
    ...
    describe("#regex", function () {
        ...
        it("should throw an error when it fails to match", function () {
    ...
    describe("#equal", function () {
        ...
        it("should validate scalar values", function () {
        ...
        it("should validate non-scalar values", function () {
        ...
        it("should throw errors on non-matching scalar values", function () {
        ...
        it("should throw errors on non-matching non-scalar values", function () {
    ...
    describe("#greaterThan", function () {
        ...
        it("should validate a number or numerical string", function () {
        ...
        it("should throw error when number or numerical string not-matched", function () {
        ...
        it("should throw type error when different data type given", function () {
